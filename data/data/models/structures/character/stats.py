...
class Stats(BaseDataclass):
    ...
    regen_hp: common.datatypes.Int32 = field(default=0)
    regen_mp: common.datatypes.Int32 = field(default=0)
    regen_cp: common.datatypes.Int32 = field(default=0)
    gain_mp: common.datatypes.Int32 = field(default=0)
    gain_hp: common.datatypes.Int32 = field(default=0)
